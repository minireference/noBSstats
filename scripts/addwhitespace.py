...
def create_wider_image(input_path, output_path):
    ...
    paste_position = (original_width // 2, 0)
...
def process_images(input_files, output_dir):
    ...
    for input_file in input_files:
        ...
        create_wider_image(input_file, output_path)
...
if __name__ == "__main__":
    ...
    process_images(args.input_files, args.outdir)